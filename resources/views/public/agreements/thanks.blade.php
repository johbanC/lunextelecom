...
<body class="min-h-screen bg-gray-100 bg-[radial-gradient(circle_at_top,_var(--color-brand-blue-50),_var(--color-gray-100)_60%)] flex items-center justify-center p-4 font-sans">
    <div class="max-w-md w-full bg-white shadow-xl shadow-gray-300/40 rounded-2xl p-8 text-center space-y-4">
        ...
        <h1 class="text-xl font-bold text-gray-800">¡Formulario enviado!</h1>
        <p class="text-gray-500 text-sm">Gracias, {{ $agreement->owner_name }}. Tu autorización para la cuenta <span class="font-bold text-brand-blue">{{ $agreement->account_id }}</span> fue recibida y firmada correctamente.</p>
    </div>
</body>
</html>
